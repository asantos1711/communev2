...
import { TIPO_NUMERO_TELEFONO, TIPO_NUMERO_TELEFONO_DELETE } from '../service/Routes'
...
export default function TipoNumeroTelefonoList({auth,handleIsEditing,path}){
    ...
    const deleteItem = (data) => {      
        setIsDeleteId(true)
        Delete({url: `${TIPO_NUMERO_TELEFONO_DELETE}/${data.id}`, access_token: auth.data.access_token})
        .then(response=>{            
            setIsDeleteId(false)   
