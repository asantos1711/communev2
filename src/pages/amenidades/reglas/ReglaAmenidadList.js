...
import { REGLAAMENIDAD_GET, TIPOAMENIDAD_GET } from '../../../service/Routes'
import Get from '../../../service/Get'
import { loaderRequest } from '../../../loaders/LoaderRequest'
import TableSkeleton from '../../../loaders/TableSkeleton'
import TableData from '../../../components/TableData'

export default function ReglaAmenidadList({auth,handleIsEditing,path}){
    ...
    const DataList = () =>{
        setIsLoading(true)
        Get({url: REGLAAMENIDAD_GET, access_token: auth.data.access_token})
        .then(response=>{           
