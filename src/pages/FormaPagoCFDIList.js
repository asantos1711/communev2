...
import { FORMA_PAGO_CFDI_GET, FORMA_PAGO_CFDI_DELETE } from '../service/Routes'
...
export  default function FormaPagoCFDIList({auth,handleIsEditing,path}){
    ...
    const deleteItem = (data) => {      
        setIsDeleteId(true)
        Delete({url: `${FORMA_PAGO_CFDI_DELETE}/${data.id}`, access_token: auth.data.access_token})
        .then(response=>{  
            setIsDeleteId(false)  
