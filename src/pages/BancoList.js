...
import { BANCO_GET,BANCO_DELETE } from '../service/Routes'
...
export default function BancoList({auth,handleIsEditing,path}){
    ...
    const deleteItem = (data) => {      
        setIsDeleteId(true)
        Delete({url: `${BANCO_DELETE}/${data.id}`, access_token: auth.data.access_token})
        .then(response=>{            
            setIsDeleteId(false)            
