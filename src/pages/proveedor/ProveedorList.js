...
import { PROVEEDOR_GET, PROVEEDOR_DELETE } from "../../service/Routes";
...
export default function ProveedorList({ auth, handleIsEditing, path }) {
  ...
  const DataList = () => {
    setIsLoading(true);
    Get({ url: PROVEEDOR_GET, access_token: auth.data.access_token })
      .then((response) => {
